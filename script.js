...
function getAllFoodDataViafilter1() {
    const newarr=foodOriginalData.filter( 
        (item) =>  item.category=="Fruit"
        );
    console.log(newarr);
}
function getAllFoodDataViafilter2() {
    const newarr=foodOriginalData.filter( 
        (item) =>  item.category=="protien"
        );s
    console.log(newarr);
}
function getAllFoodDataViafilter3() {
    const newarr=foodOriginalData.filter( 
        (item) =>  item.category=="nuts"
        );
    console.log(newarr);
}
function getAllFoodDataViafilter4() {
    const newarr=foodOriginalData.filter( 
        (item) =>  item.category=="grains"
        );
    console.log(newarr);
}
function getAllFoodDataViafilter5() {
    const newarr=foodOriginalData.filter( 
...
function sortFoodByProtein(foodArray) {
  ...
  console.log("Food Items Sorted by Protein Content:");
  sortedFoodByProtein.forEach((food, index) => {
  ...
  console.log("Food Items Sorted by Carbohydrate Content (Low to High):");
  sortedFoodByCarbs.forEach((food, index) => {
    console.log(`${index + 1}. ${food.foodname} - ${food.cab}g of carbs`);
  });
